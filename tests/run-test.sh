...
cp -R ~/GitHub/ansible-role-jvm-developer /tmp/roles/kurron.jvm-developer
...
CMD="docker run --env DISPLAY=unix${DISPLAY} \
                --env HOME=${HOME_DIR} \
                --env IDEA_JDK=/usr/lib/jvm/amazon-jdk-8 \
                ...
                kurron/ansible-role-jvm-developer:latest bash"
echo $CMD
$CMD
